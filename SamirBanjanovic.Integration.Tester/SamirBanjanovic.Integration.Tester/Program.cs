...
using OnTrac.Integration.Components.FileWatcher;
using OnTrac.Integration.Components.QuartzScheduler;
using OnTrac.Integration.Components.WebApi;
using OnTrac.Integration.Core;
using OnTrac.Integration.Extensions.Logging;
using OnTrac.Integration.Publishers.Basic;
using Serilog;


namespace OnTrac.Integration.Tester
{
