...
namespace OnTrac.Integration.Components.Master.Tester.NodeTests
{
    ...
    public class NodeWebApiAccessServiceTests
    {
        ...
        public async Task TestUploadPackageAsync()
        {
            ...
            using (var file = File.OpenRead(@"C:\repos\Integration Platform\OnTrac.Integration.Components.Master\UnitTests\p4.zip"))
            {
        ...
        public async Task TestUpdatePackageAsync()
        {
            ...
            using (var file = File.OpenRead(@"C:\repos\Integration Platform\OnTrac.Integration.Components.Master\UnitTests\p4_config.zip"))
            {
            ...
            using (var file = File.OpenRead(@"C:\repos\Integration Platform\OnTrac.Integration.Components.Master\UnitTests\configuration.json"))
            {
